...
const Projects = () => {
    return (
        <section className="pt-20" id="projects">
            ...
            className="mb-8 p-10 text-center text-3xl lg:text-4xl">
                Projects
            </motion.h2>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                {PROJECTS.map((projects) => (
                    ...
                    key={projects.id} className="group relative overflow-hidden rounded-3xl">
                        <motion.img
                        ...
                        className="absolute inset-0 flex flex-col items-center justify-center text-white opacity-0 backdrop-blur-lg transition-opacity duration-500 group-hover:opacity-100">
                            ...
                            <p className="mb-2 p-4">{projects.description}</p>
                            <a
